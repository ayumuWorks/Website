			...
			<div class="container">
				...
				<?php
					...
					if( !empty($zerif_latestnews_title) ):
						echo '<h2 class="">' . __($zerif_latestnews_title,'zerif-lite') . '</h2>';
					else:
						echo '<h2 class="">' . __('Latest news','zerif-lite') . '</h2>';
					endif;
					...
					if( !empty($zerif_latestnews_subtitle) ):
						...
						echo '<h6 class="">'.__($zerif_latestnews_subtitle,'zerif-lite').'</h6>';
				...
				<div id="carousel-homepage-latestnews" class="carousel slide" data-ride="carousel">
					...
					<?php 
						...
						?>
							...
							<div class="item <?php echo $active; ?>">
								<div class="col-md-4 latestnews-box">
									<div class="latestnews-img">
										<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
											<?php the_post_thumbnail(); ?>
										</a>
					...
					<a href="http://localhost/inoveta/wp-content/themes/zerif-lite/index.php" class="blog">投稿一覧へ</a>
				</div>
