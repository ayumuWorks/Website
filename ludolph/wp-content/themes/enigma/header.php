...
<?php
	...
	<link rel="stylesheet" href="http://ludolph-rits.vivian.jp/wordpress-green/wp-content/themes/enigma/slider/flexslider.css" type="text/css" />
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script>
	<script src="http://ludolph-rits.vivian.jp/wordpress-green/wp-content/themes/enigma/slider/jquery.flexslider.js"></script>
		...
		<div class="container" >
			...
			<div class="row ">
				<div class="col-md-6 col-sm-12 wl_rtl" >					
					...
					<?php } else { echo __('立命館大学Ludolph','weblizar'); } ?>
					</a>
					<p>アルティメットサークル</p>
					</div>
				</div>
