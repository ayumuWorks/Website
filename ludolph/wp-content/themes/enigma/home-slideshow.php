<!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <!-- デファルト変更-->
	  <?php 
	  	$wl_theme_options[slide_title_1] = '立命館大学アルティメットサークル';
	  	$wl_theme_options[slide_desc_1] = '創部１０周年！！';

	  	$wl_theme_options[slide_title_2] = '立命館大学アルティメットサークル';
	  	$wl_theme_options[slide_desc_2] = '創部１０周年！！';

	  	$wl_theme_options[slide_title_3] = '立命館大学アルティメットサークル';
	  	$wl_theme_options[slide_desc_3] = '創部１０周年！！';
	  ?>
	  <!-- 変更終了 -->
