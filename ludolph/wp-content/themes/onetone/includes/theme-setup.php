...
add_action( 'after_setup_theme', 'onetone_setup' );
 ...
 function onetone_custom_scripts(){
	...
	wp_enqueue_style( 'onetone-main', get_stylesheet_uri(), array(), '1.4.2' );
   ...
   $onetone_custom_css = "";
	...
	wp_enqueue_script( 'onetone-default', get_template_directory_uri().'/js/onetone.js', array( 'jquery' ), '1.4.2', true );
